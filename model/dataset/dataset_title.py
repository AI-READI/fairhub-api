...
class DatasetTitle(db.Model):
    ...
    dataset_contributor = db.relationship(
        "DatasetContributor", back_populates="dataset_title"
    )
    ...
    def from_data(data: dict):
        dataset_contributor = DatasetTitle()
        # dataset_contributor.id = data["id"]
        dataset_contributor.title = data["title"]
        dataset_contributor.type = data["type"]
