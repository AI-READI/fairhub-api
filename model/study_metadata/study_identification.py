...
class StudyIdentification(db.Model):  # type: ignore
    ...
    def update(self, data: dict):
        ...
        self.identifier_domain = data["identifier_domain"] if\
            "identifier_domain" in data else ""
        self.identifier_link = data["identifier_link"] if\
            "identifier_link" in data else ""
        self.study.touch()
