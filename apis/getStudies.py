...
def getStudies():
    return [
        ...
        },
        {
            ...
            "owner": {"name": "Sanjay Soundarajan", "email": "sanjay@email.org"},
            "size": " 1.2 GB",
        },
    ]
...
def getDatasets(studyId):
    datasets = {
        1: [
            {"id": 1, "name": "AI-READI", "versions": [{"id": 1}, {"id": 2}]},
            {"id": 2, "name": "AI-READI2", "versions": [{"id": 1}, {"id": 2}]},
        ],
        2: [
            {"id": 1, "name": "AI-READI3", "versions": [{"id": 1}, {"id": 2}]},
            {"id": 2, "name": "AI-READI4"},
        ],
    }
