...
redcap_report_participants_data = api.model("RedcapReportParticipantsData", {
...
class RedcapReportParticipantsDataResource(Resource):
    ...
    def get(self, study_id: int, redcap_project_id: str):
        ...
        participants = PyCapProject.export_report(study_redcap_["redcap_report_id_participants"])
        return participants
