...
redcap_report_repeat_surveys_data = api.model("RedcapReportRepeatSurveysData", {
...
class RedcapReportRepeatSurveysDataResource(Resource):
    ...
    def get(self, study_id: int, redcap_project_id: str):
        ...
        repeat_surveys = PyCapProject.export_report(study_redcap_["redcap_report_id_repeat_surveys"])
