...
redcap_report_participant_values_data = api.model("RedcapReportParticipantValuesData", {
...
class RedcapReportParticipantValuesDataResource(Resource):
    ...
    def get(self, study_id: int, redcap_project_id: str):
        ...
        participant_values = PyCapProject.export_report(study_redcap_["redcap_report_id_participant_values"])
