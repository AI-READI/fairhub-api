...
redcap_report_survey_completions_data = api.model("RedcapReportSurveyCompletionsData", {
...
class RedcapReportSurveyCompletionsDataResource(Resource):
    ...
    def get(self, study_id: int, redcap_project_id: str):
        ...
        PyCapProject = Project(study_redcap_["redcap_api_url"], study_redcap_["redcap_api_token"])
        survey_completions = PyCapProject.export_report(study_redcap_["redcap_report_id_survey_completions"])
