...
REDCapProjectDataModel = {
    ...
    "secondary_unique_field": fields.String(required=True, readonly=True, description=""),
    "is_longitudinal": fields.Boolean(required=True, readonly=True, description=""),
    "has_repeating_instruments_or_events": fields.Boolean(required=True, readonly=True, description=""),
    ...
    "record_autonumbering_enabled": fields.Boolean(required=True, readonly=True, description=""),
    "randomization_enabled": fields.Boolean(required=True, readonly=True, description=""),
    ...
    "display_today_now_button": fields.Boolean(required=True, readonly=True, description=""),
    ...
    "bypass_branching_erase_field_prompt": fields.Boolean(required=True, readonly=True, description="")
}
