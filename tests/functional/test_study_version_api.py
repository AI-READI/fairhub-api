...
#         (
#             index
#             for (index, d) in enumerate(response_data["related_identifiers"][0]["titles"])
#             if d["type"] == "MainTitle"
#         ),
#         None,
#     )
#     # seach for subtitle index in response_data["related_identifiers"][0]["titles"]
#     sub_title_0 = next(
#         (
#             index
#             for (index, d) in enumerate(response_data["related_identifiers"][0]["titles"])
...
#                 admin_response_data["related_identifiers"][0]["titles"]
#             )
#             if d["type"] == "MainTitle"
#         ),
#         None,
...
#             index
#             for (index, d) in enumerate(
#                 editor_response_data["related_identifiers"][0]["titles"]
#             )
#             if d["type"] == "MainTitle"
#         ),
#         None,
...
#     assert response_data["related_identifiers"][0]["publication_year"] == "1970"
#     assert response_data["related_identifiers"][0]["publisher"] == "Publisher"
#     assert response_data["related_identifiers"][0]["contributors"][0]["name"] == "Ndafsdame"
#     assert (
#         response_data["related_identifiers"][0]["contributors"][0]["contributor_type"]
#         == "Con Type"
#     )
#     assert response_data["related_identifiers"][0]["creators"][0]["name"] == "Name"
#     assert response_data["related_identifiers"][0]["creators"][0]["name_type"] == "Personal"
#     assert response_data["related_identifiers"][0]["titles"][main_title_0]["title"] == "Title"
#     assert (
#         response_data["related_identifiers"][0]["titles"][main_title_0]["type"] == "MainTitle"
#     )
#     assert response_data["related_identifiers"][0]["titles"][sub_title_0]["title"] == "Title"
#     assert (
#         response_data["related_identifiers"][0]["titles"][sub_title_0]["type"] == "Subtitle"
#     )
#     assert (
#         response_data["related_identifiers"][0]["identifiers"][0]["identifier"]
#         == "Identifier"
#     )
#     assert response_data["related_identifiers"][0]["identifiers"][0]["type"] == "ARK"
#     assert response_data["related_identifiers"][0]["type"] == "Type"
#
...
#     assert admin_response_data["related_identifiers"][0]["publication_year"] == "1970"
#     assert admin_response_data["related_identifiers"][0]["publisher"] == "Publisher"
#     assert (
#         admin_response_data["related_identifiers"][0]["contributors"][0]["name"]
#         == "Ndafsdame"
#     )
#     assert (
#         admin_response_data["related_identifiers"][0]["contributors"][0]["contributor_type"]
#         == "Con Type"
#     )
#     assert admin_response_data["related_identifiers"][0]["creators"][0]["name"] == "Name"
#     assert (
#         admin_response_data["related_identifiers"][0]["creators"][0]["name_type"]
#         == "Personal"
#     )
#     assert (
#         admin_response_data["related_identifiers"][0]["titles"][a_main_title_0]["title"]
#         == "Title"
#     )
#     assert (
#         admin_response_data["related_identifiers"][0]["titles"][a_main_title_0]["type"]
#         == "MainTitle"
#     )
#     assert (
#         admin_response_data["related_identifiers"][0]["titles"][a_sub_title_0]["title"]
#         == "Title"
#     )
#     assert (
#         admin_response_data["related_identifiers"][0]["titles"][a_sub_title_0]["type"]
#         == "Subtitle"
#     )
#     assert (
#         admin_response_data["related_identifiers"][0]["identifiers"][0]["identifier"]
#         == "Identifier"
#     )
#     assert admin_response_data["related_identifiers"][0]["identifiers"][0]["type"] == "ARK"
#     assert admin_response_data["related_identifiers"][0]["type"] == "Type"
#
...
#     assert editor_response_data["related_identifiers"][0]["publication_year"] == "1970"
#     assert editor_response_data["related_identifiers"][0]["publisher"] == "Publisher"
#     assert (
#         editor_response_data["related_identifiers"][0]["contributors"][0]["name"]
#         == "Ndafsdame"
#     )
#     assert (
#         editor_response_data["related_identifiers"][0]["contributors"][0]["contributor_type"]
#         == "Con Type"
#     )
#     assert editor_response_data["related_identifiers"][0]["creators"][0]["name"] == "Name"
#     assert (
#         editor_response_data["related_identifiers"][0]["creators"][0]["name_type"]
#         == "Personal"
#     )
#     assert (
#         editor_response_data["related_identifiers"][0]["titles"][e_main_title_0]["title"]
#         == "Title"
#     )
#     assert (
#         editor_response_data["related_identifiers"][0]["titles"][e_main_title_0]["type"]
#         == "MainTitle"
#     )
#     assert (
#         editor_response_data["related_identifiers"][0]["titles"][e_sub_title_0]["title"]
#         == "Title"
#     )
#     assert (
#         editor_response_data["related_identifiers"][0]["titles"][e_sub_title_0]["type"]
#         == "Subtitle"
#     )
#     assert (
#         editor_response_data["related_identifiers"][0]["identifiers"][0]["identifier"]
#         == "Identifier"
#     )
#     assert editor_response_data["related_identifiers"][0]["identifiers"][0]["type"] == "ARK"
#     assert editor_response_data["related_identifiers"][0]["type"] == "Type"
