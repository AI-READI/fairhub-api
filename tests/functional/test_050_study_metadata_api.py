...
#                       "identifier_scheme_uri": "collaborator1123",
#                       }],
#                 "sponsors":{"lead_sponsor_identifier_scheme": "scheme",
...
#     assert response_data["collaborators"][0]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     )  # noqa: E501
#     assert (
#             response_data["sponsors"]["responsible_party_investigator_identifier_value"] == "identifier"
#     )
#     assert response_data["sponsors"]["responsible_party_investigator_identifier_scheme"] == "scheme"
#     assert (
#             response_data["sponsors"]["responsible_party_investigator_identifier_scheme_uri"] == "uri"
#     )
#     assert (
...
#     )
#     assert (
#             response_data["sponsors"]["responsible_party_investigator_affiliation_identifier_value"]
#             == "identifier"
#     )
#     assert (
#             response_data["sponsors"]["responsible_party_investigator_affiliation_identifier_scheme"]
#             == "scheme"
#     )
#     assert (
...
#     assert admin_response.status_code == 201
#     admin_response_data = json.loads(admin_response.data)
#     pytest.global_admin_collaborators_id_admin = admin_response_data["collaborators"][0]["id"]
#
...
#     assert admin_response_data["collaborators"][0]["identifier_scheme"] == "collaborator1123"
#     assert admin_response_data["collaborators"][0]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     assert (
#             admin_response_data["sponsors"]["responsible_party_investigator_title"] == "title"
#     )  # noqa: E501
#     assert (
#             admin_response_data["sponsors"]["responsible_party_investigator_identifier_value"] == "identifier"
#     )
#     assert admin_response_data["sponsors"]["responsible_party_investigator_identifier_scheme"] == "scheme"
#     assert (
#             admin_response_data["sponsors"]["responsible_party_investigator_identifier_scheme_uri"] == "uri"
#     )
#     assert (
#             admin_response_data["sponsors"]["responsible_party_investigator_affiliation_name"]
#             == "affiliation"
#     )
#     assert (
#             admin_response_data["sponsors"]["responsible_party_investigator_affiliation_identifier_value"]
#             == "identifier"
#     )
#     assert (
#             admin_response_data["sponsors"]["responsible_party_investigator_affiliation_identifier_scheme"]
#             == "scheme"
#     )
#     assert (
...
#     assert admin_response_data["sponsors"]["lead_sponsor_identifier_scheme_uri"] == "uri"
#
#     editor_response = _editor_client.post(
#         f"/study/{study_id}/metadata/team",
#         json=
#         {
#             "collaborators": [{"name": "editor collaborator1123",
#                                "identifier": "collaborator1123",
#                                "identifier_scheme": "collaborator1123",
#                                "identifier_scheme_uri": "collaborator1123",
#                                },
...
#     assert editor_response.status_code == 201
#     editor_response_data = json.loads(editor_response.data)
#     pytest.global_editor_collaborators_id_editor = editor_response_data["collaborators"][0]["id"]
#
...
#     assert editor_response_data["collaborators"][0]["identifier_scheme"] == "collaborator1123"
#     assert editor_response_data["collaborators"][0]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     assert (
#             editor_response_data["sponsors"]["responsible_party_investigator_title"] == "title"
#     )  # noqa: E501
#     assert (
#             editor_response_data["sponsors"]["responsible_party_investigator_identifier_value"] == "identifier"
#     )
#     assert editor_response_data["sponsors"]["responsible_party_investigator_identifier_scheme"] == "scheme"
#     assert (
#             editor_response_data["sponsors"]["responsible_party_investigator_identifier_scheme_uri"] == "uri"
#     )
#     assert (
#             editor_response_data["sponsors"]["responsible_party_investigator_affiliation_name"]
#             == "affiliation"
#     )
#     assert (
#             editor_response_data["sponsors"]["responsible_party_investigator_affiliation_identifier_value"]
#             == "identifier"
#     )
#     assert (
#             editor_response_data["sponsors"]["responsible_party_investigator_affiliation_identifier_scheme"]
#             == "scheme"
#     )
#     assert (
...
#     assert editor_response_data["sponsors"]["lead_sponsor_identifier_scheme"] == "scheme"
#     assert editor_response_data["sponsors"]["lead_sponsor_identifier_scheme_uri"] == "uri"
#
#     viewer_response = _viewer_client.post(
#         f"/study/{study_id}/metadata/team",
#         json=
#         {
#             "collaborators": [{"name": "collaborator1123",
#                                "identifier": "collaborator1123",
#                                "identifier_scheme": "collaborator1123",
#                                "identifier_scheme_uri": "collaborator1123",
#                                },
...
#     assert viewer_response_data["collaborators"][0]["identifier_scheme"] == "collaborator1123"
#     assert viewer_response_data["collaborators"][0]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     assert response_data["collaborators"][1]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     assert admin_response_data["collaborators"][1]["identifier_scheme"] == "collaborator1123"
#     assert admin_response_data["collaborators"][1]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     assert editor_response_data["collaborators"][1]["identifier_scheme"] == "collaborator1123"
#     assert editor_response_data["collaborators"][1]["identifier_scheme_uri"] == "collaborator1123"
#
...
#     assert viewer_response_data["collaborators"][1]["identifier_scheme"] == "collaborator1123"
#     assert viewer_response_data["collaborators"][1]["identifier_scheme_uri"] == "collaborator1123"
#
#     assert response_data["sponsors"]["responsible_party_type"] == "Sponsor"
#     assert response_data["sponsors"]["responsible_party_investigator_first_name"] == "name"
#     assert response_data["sponsors"]["responsible_party_investigator_last_name"] == "surname"
...
#     )  # noqa: E501
#     assert (
#         admin_response_data["sponsors"]["responsible_party_investigator_identifier_value"]
#         == "identifier"
#     )
#     assert (
#         admin_response_data["sponsors"]["responsible_party_investigator_identifier_scheme"]
#         == "scheme"
#     )
#     assert (
#         admin_response_data["sponsors"]["responsible_party_investigator_identifier_scheme_uri"]
#         == "uri"
#     )
#     assert (
#         admin_response_data["sponsors"]["responsible_party_investigator_affiliation_name"]
...
#     )  # noqa: E501
#     assert (
#         editor_response_data["sponsors"]["responsible_party_investigator_identifier_value"]
#         == "identifier"
#     )
#     assert (
#         editor_response_data["sponsors"]["responsible_party_investigator_identifier_scheme"]
#         == "scheme"
#     )
#     assert (
#         editor_response_data["sponsors"]["responsible_party_investigator_identifier_scheme_uri"]
#         == "uri"
#     )
#     assert (
#         editor_response_data["sponsors"]["responsible_party_investigator_affiliation_name"]
...
#     assert (
#         viewer_response_data["sponsors"]["responsible_party_investigator_title"] == "title"
#     )  # noqa: E501
#     assert (
#         viewer_response_data["sponsors"]["responsible_party_investigator_identifier_value"]
#         == "identifier"
#     )
#     assert (
#         viewer_response_data["sponsors"]["responsible_party_investigator_identifier_scheme"]
#         == "scheme"
#     )
#     assert (
#         viewer_response_data["sponsors"]["responsible_party_investigator_identifier_scheme_uri"]
#         == "uri"
#     )
#     assert (
#         viewer_response_data["sponsors"]["responsible_party_investigator_affiliation_name"]
#         == "affiliation"
#     )
#     assert (
...
#     assert viewer_response_data["sponsors"]["lead_sponsor_identifier_scheme"] == "scheme"
#     assert viewer_response_data["sponsors"]["lead_sponsor_identifier_scheme_uri"] == "uri"
#
#     assert response_data["collaborators"][1]["name"] == "collaborator1123"
#     assert response_data["collaborators"][1]["identifier"] == "collaborator1123"
#     assert response_data["collaborators"][1]["identifier_scheme"] == "collaborator1123"
...
def test_post_description_metadata(clients):
    ...
    assert response_data["conditions"][0]["classification_code"] == "classification code"
    ...
    print(response_data["identification"]["secondary"][0], "gggggggggg")
    ...
    assert response_data["identification"]["secondary"][0]["identifier_domain"] == "dodfasdfmain"
    ...
    assert response_data["description"]["detailed_description"] == "detailed_description"
    ...
    assert admin_response.status_code == 200
    admin_response_data = json.loads(admin_response.data)
    pytest.global_identification_id = admin_response_data["identification"]["secondary"][0]["id"]
    pytest.global_keywords_id = admin_response_data["keywords"][0]["id"]
    pytest.global_conditions_id = admin_response_data["conditions"][0]["id"]

    assert admin_response_data["conditions"][0]["name"] == "condition"
    assert admin_response_data["conditions"][0]["classification_code"] == "classification code"
    ...
    assert admin_response_data["keywords"][0]["classification_code"] == "classification code"
    ...
    print(admin_response_data["identification"]["secondary"][0], "gggggggggg")
    ...
    assert admin_response_data["identification"]["primary"]["identifier_domain"] == "domain"
    ...
    assert admin_response_data["identification"]["secondary"][0]["identifier_type"] == "test"
    assert admin_response_data["identification"]["secondary"][0]["identifier_domain"] == "dodfasdfmain"
    assert admin_response_data["identification"]["secondary"][0]["identifier_link"] == "link"

    assert admin_response_data["description"]["brief_summary"] == "brief_summary"
    assert admin_response_data["description"]["detailed_description"] == "detailed_description"
    ...
    assert editor_response.status_code == 200
    editor_response_data = json.loads(editor_response.data)
    pytest.global_identification_id = editor_response_data["identification"]["secondary"][0]["id"]
    pytest.global_keywords_id = admin_response_data["keywords"][0]["id"]
    pytest.global_conditions_id = admin_response_data["conditions"][0]["id"]

    assert editor_response_data["conditions"][0]["name"] == "condition"
    assert editor_response_data["conditions"][0]["classification_code"] == "classification code"
    ...
    assert editor_response_data["keywords"][0]["classification_code"] == "classification code"
    ...
    print(editor_response_data["identification"]["secondary"][0], "gggggggggg")
    assert editor_response_data["identification"]["primary"]["identifier"] == "first"
    assert editor_response_data["identification"]["primary"]["identifier_type"] == "test"
    assert editor_response_data["identification"]["primary"]["identifier_domain"] == "domain"
    assert editor_response_data["identification"]["primary"]["identifier_link"] == "link"
    assert editor_response_data["identification"]["secondary"][0]["identifier"] == "test"
    assert editor_response_data["identification"]["secondary"][0]["identifier_type"] == "test"
    assert editor_response_data["identification"]["secondary"][0]["identifier_domain"] == "dodfasdfmain"
    assert editor_response_data["identification"]["secondary"][0]["identifier_link"] == "link"

    assert editor_response_data["description"]["brief_summary"] == "brief_summary"
    assert editor_response_data["description"]["detailed_description"] == "detailed_description"
...
#     )
#
#     assert viewer_response.status_code == 40
# #
