...
def test_post_available_ipd_metadata(test_client, login_user):
    ...
    # study_id = pytest.global_study_id["id"]
    # response = test_client(f"/study/{study_id}/metadata/available-ipd", json={
...
def test_get_available_ipd_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/available-ipd")
    assert response.status_code == 200
...
def test_get_conditions_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/conditions")
    assert response.status_code == 200
...
def test_get_intervention_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/intervention")
    assert response.status_code == 200
...
def test_get_ipdsharing_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/ipdsharing")
    assert response.status_code == 200
...
def test_get_link_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/link")
    assert response.status_code == 200
...
def test_get_location_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/location")
    assert response.status_code == 200
...
def test_get_other_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/other")
    assert response.status_code == 200
...
def test_get_overall_official_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/overall-official")
    assert response.status_code == 200
...
def test_get_oversight_official_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/oversight")
    assert response.status_code == 200
...
def test_get_reference_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/reference")
    assert response.status_code == 200
...
def test_get_status_metadata(test_client, login_user):
    ...
    """
    study_id = pytest.global_study_id["id"]
    response = test_client.get(f"/study/{study_id}/metadata/status")
    assert response.status_code == 200
