...
redcapTransformConfig = {
	"reports": [
		...
		("dashboard_data_study_waypoints", {"report_id": 251954}, [
			...
			("keep_columns", {
				"columns": index_columns + survey_columns
			})
		]),
		("dashboard_data_repeat_instruments", {"report_id": 259920}, [
			("drop_rows", {
				"columns": repeat_survey_columns
			}),
...
# Sex & Gender Counts by Site
mixedTransformTestConfig = ("mixedTransform", {
