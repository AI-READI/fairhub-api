...
AZURE_CONTAINER = get_env("AZURE_CONTAINER")
...
FAIRHUB_SMTP_CONNECTION_STRING = get_env("FAIRHUB_SMTP_CONNECTION_STRING")
...
FAIRHUB_FRONTEND_URL = get_env("FAIRHUB_FRONTEND_URL")